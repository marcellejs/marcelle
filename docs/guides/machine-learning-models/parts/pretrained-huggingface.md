...
### Solution 1: Use a model hosted on Huggingface.co <span :class="$style.tip">Recommended</span>

TODO

### Solution 2: client-side inference with Transformers.js <span :class="$style.tip">Recommended&nbsp;for&nbsp;small&nbsp;transformers</span>
...
Another solution consists in using a Python web framework of serving library to expose the model at a HTTP endpoint. Several possibilities exist, including generic web frameworks such as [Starlette](https://www.starlette.io/).
